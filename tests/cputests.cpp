...
TEST_CASE("CPU instruction LB_BC_d16(0x01) runs correctly") {
    ...
    cpu.testMemory = { 0x01, 0x43, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00}; //should load 0x43 to reg C and 0x42 to reg B
    cpu.step();
...
TEST_CASE("CPU instruction LD_pBC_A(0x02) runs correctly") {
    ...
    std::vector<uint8_t> answer = {0x02, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    cpu.step();
